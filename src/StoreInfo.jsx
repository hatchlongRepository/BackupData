            ...
            <div style={{ marginLeft: '20px' }}>
                ...
                <div class='row' >
                    <div class='col-sm-6'>
                        ...
                        <input type="text" placeholder='Enter Store Name' value={st_name} onChange={(e) => setName(e.target.value)} style={{ height: '40px', width: '450px', borderRadius: '5px', border: '1px solid grey' }} /><br />

                        <label style={{ fontSize: '16px', color: 'grey', marginTop: '15px' }}>Store Manager Name *</label><br />
                        <input type="text" placeholder='Enter Manager Name' value={st_man_name} onChange={(e) => setMname(e.target.value)} style={{ height: '40px', width: '450px', borderRadius: '5px', border: '1px solid grey' }} /><br />

                        <label style={{ fontSize: '16px', color: 'grey', marginTop: '25px' }}>Phone Number *</label><br />
                        <input type="number" placeholder='Enter Phone Number' value={st_contact} onChange={(e) => setContact(e.target.value)} style={{ height: '40px', width: '450px', borderRadius: '5px', border: '1px solid grey' }} />
                        ...
                        <input type="text" placeholder='P.O. Box' value={st_po_box} onChange={(e) => setBox(e.target.value)} style={{ height: '40px', width: '450px', borderRadius: '5px', border: '1px solid grey' }} /><br />
                        ...
                        <input type="text" placeholder='Enter Address 1' value={st_add1} onChange={(e) => setAddress(e.target.value)} style={{ height: '40px', width: '450px', borderRadius: '5px', border: '1px solid grey' }} /><br />
                    ...
                    <div class='col-sm-6'>
                        ...
                        <input type="email" placeholder='Enter Your Email' value={st_email} onChange={(e) => setEmail(e.target.value)} style={{ height: '40px', width: '450px', borderRadius: '5px', border: '1px solid grey' }} /><br />
