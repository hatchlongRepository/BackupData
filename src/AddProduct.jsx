        ...
        <>
            ...
            <div class='row'>
                ...
                <div class='col-md-6'>
                    ...
                    <form action="">
                        <select className='select-store' style={{border:'1px solid grey'}}>Select store
                        ...
                        <select className='select-s'>Select store
                            <option>Select a unit type</option>
                        </select>
                        <select className='select-s' style={{ marginLeft: '24px' }}>Select store
                            <option>Unit</option>
                        </select>
